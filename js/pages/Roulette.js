...
export default {
                ...
                <div class="levels">
                    ...
                    <template v-if="levels.length > 0">
                        ...
                        <div v-if="givenUp || hasCompleted" class="results">
                            ...
                            <Btn v-if="currentPercentage < 99 && !hasCompleted"
    ...
    computed: {
        ...
        hasCompleted() {
            return (
                (this.progression[this.progression.length - 1] ?? 0) >= 100 ||
    ...
    methods: {
        ...
        async onStart() {
            ...
            const fullList = await fetchList(store.mode);

            if (fullList.filter(([_, err]) => err).length > 0) {
                this.loading = false;
                this.showToast('List is currently broken.');
                return;
            }
