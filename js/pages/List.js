...
export default {
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="dark-bg">
                        <h2>Guidelines</h2>
                        <p>
                            Every action follows the guidelines. Check them before submitting a record.
                        </p>
                        ...
                        <ol class="editors">
                            <li v-for="editor in editors">
                                <img
                                    ...
                                    :alt="editor.role"
                                >
                                <a v-if="editor.link" target="_blank" :href="editor.link">
                                    {{ editor.name }}
                                </a>
                    ...
                    <div class="dark-bg og">
                        <p>
                            All credit goes to TSL. This is a replica with permission.
                        </p>
                    </div>
    ...
    async mounted() {
        // ✅ HARDENED MODE DETECTION
        const routeMode = this.$route.meta?.list;

        const mode =
            routeMode ||
            (this.$route.path.startsWith("/demons") ? "demon" : "challenge");
        ...
        if (!this.list) {
            this.errors = [
                "Failed to load list. Retry in a few minutes or notify staff.",
            ];
        } else {
            this.errors.push(
                ...this.list
