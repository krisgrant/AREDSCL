            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="dark-bg">
                        ...
                        <p>
                            <button class="btn-no-cover" @click="selected = 37">
                                Ship challenge 4 has been removed (Formerly at #38). This change pushes KrisYas Bad Time back into the Extended List.
                            </button>
                        </p>
                    </div>
                    ...
                    <div class="og dark-bg">
                        <p>
                            All credit goes to TSL, whose website this is a replica of.
                        </p>
                    </div>
