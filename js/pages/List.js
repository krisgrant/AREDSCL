...
export default {
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="dark-bg">
                        <h2>Guidelines</h2>
                        <br>
                        <p>Every action is conducted in accordance with our guidelines.</p>
                        <br>
                    ...
                    <div class="dark-bg" v-if="editors">
                        ...
                        <ol class="editors">
                            <li v-for="editor in editors">
                                ...
                                <a v-if="editor.link" target="_blank">{{ editor.name }}</a>
    ...
    async mounted() {
        // ✅ SAFE MODE DETECTION (this is the key fix)
